...
if __name__ == "__main__":
    ...
    # parser.add_option('--config', type=str, required=True, help='Path to config file')
    parser.add_option("-o", '--output', dest="output", type="str", help='Output directory for logs')
